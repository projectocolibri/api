...
public class DragNDropManager{
	...
	public DragNDropManager() throws Exception {
		Debug.info();
	}


	public void createDragObject(Control sourceControl){
	...
	public void addSourceListneres(DragSource source){
	...
	public void createDropObject(Control targetControl){
	...
	public void addTargetListeners(){
