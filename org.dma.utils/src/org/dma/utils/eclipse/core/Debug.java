...
import org.dma.utils.java.integer.IntegerUtils;
...
public class Debug {
	...
	private static void warning2(String message, Object obj) {
		if (IntegerUtils.bit(TYPE, TYPE_WARNING)){
			String logMessage=getLogMessage("###WARNING### "+message,obj);
	...
	private static void info2(String message, Object obj) {
		if (IntegerUtils.bit(TYPE, TYPE_INFO)){
			String logMessage=getLogMessage(message,obj);
			System.out.println(logMessage);
		}
	}


	private static String getLogMessage(String message, Object obj) {
