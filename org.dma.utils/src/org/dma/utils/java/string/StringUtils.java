...
public class StringUtils {
	 ...
	 * Creation
	 */
	public static String replicate(String character, int replicas) {
	...
	public static Integer[] indexOf(String string, String delimiter){

		Collection<Integer> result=new ArrayList();

		int index=string.indexOf(delimiter, 0);
		while(index!=-1){
			result.add(index);
	...
	public static String[] splitInside(String string, String delimiter1, String delimiter2){
		...
		for(int i=0; i<indexes1.length; i++)
			result.add(string.substring(indexes1[i]+1, indexes2[i]));
	...
	public static String remove(String string, String[] searchFor, String delimiter){
