		...
		INewLibraryCreationPage
{
	...
	private final String fileExtension = IReportElementConstants.LIBRARY_FILE_EXTENSION;
			...
			String sourceFileName, IProgressMonitor monitor )
	{
		...
		try
		{
			...
			{
				handle.setStringProperty( IDesignElementModel.COMMENTS_PROP,
						ReportPlugin.getDefault( ).getCommentPreference( ) );
			}

			if ( ReportPlugin.getDefault( ).getDefaultUnitPreference( ) != null )
			{
				handle.setStringProperty( IModuleModel.UNITS_PROP,
