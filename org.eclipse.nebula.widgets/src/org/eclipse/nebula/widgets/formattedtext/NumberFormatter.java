 ...
 *     Marco Lopes (marcolopes@netc.pt) - Code adjustments
 *******************************************************************************/
...
public class NumberFormatter extends AbstractFormatter {
	...
	public NumberFormatter() {
		this(null, null, Locale.getDefault(), false);
	}
	...
	public NumberFormatter(String editPattern) {
		this(editPattern, null, Locale.getDefault(), false);
	}
	...
	public NumberFormatter(String editPattern, Locale loc) {
		this(editPattern, null, loc, false);
	}
	 ...
	 */
	public NumberFormatter(String editPattern, String displayPattern, boolean cell) {
		this(editPattern, displayPattern, Locale.getDefault(),cell);
	}
	 ...
	 * @param loc locale
	 */
	public NumberFormatter(String editPattern, String displayPattern, Locale loc, boolean cell) {
		this.locale = loc;
		this.cell=cell;
		alwaysShowDec = false;
	...
	public void verifyText(VerifyEvent e) {
		...
		/*
		 * When a cell is selected on a CellEditor, the event is fired
		 * with the complete cell text in the e.text field, causing
		 * the formatter to insert the existing text as new text
		 */
		if(cell && e.text.length()>1) {
			e.doit=false;
			return;
		}
